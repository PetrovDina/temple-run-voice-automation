...
Note: this is an older version of our main file,
which saved and retrieved detected voice commands and generated spectrograms
on the file system
It was replaced with the "voice-automated-gameplay.py" script for performance optimization
